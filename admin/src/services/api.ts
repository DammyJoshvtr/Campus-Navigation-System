...
export const loginAdmin = (email: string, password: string) => api.post('/auth/login', { email, password });
...
export const createLocation = (data: Partial<Location>) => api.post('/locations', data);
export const updateLocation = (id: number, data: Partial<Location>) => api.put(`/locations/${id}`, data);
export const deleteLocation = (id: number) => api.delete(`/locations/${id}`);

// Events
export const getEvents = () => api.get('/events?all=true');
export const createEvent = (data: Partial<Event>) => api.post('/events/create', data); // Used create from backend
export const updateEvent = (id: number, data: Partial<Event>) => api.put(`/events/${id}`, data);
...
// Approvals
export const approveContent = (type: string, id: number, status: string) => api.put(`/admin/approve/${type}/${id}`, { status });
