        ...
        >
          ...
          {!editing && (
            <View style={[styles.card, { backgroundColor: theme.surface, borderColor: theme.border }]}>
              ...
              {[
                { label: "Saved Places",   icon: <MapPin size={18} color={theme.primary} /> },
                { label: "My Routes",      icon: <MapPin size={18} color={theme.primary} /> },
              ].map((item) => (
                <TouchableOpacity
                  key={item.label}
...
const styles = StyleSheet.create({
  ...
  statLabel:   { fontSize: 12, fontFamily: "PlusJakartaSans_400Regular", marginTop: 2 },
